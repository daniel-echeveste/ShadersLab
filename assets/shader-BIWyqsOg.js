import{u as g,s as c,T as u,r as n,t as d,c as h,j as r,E as j}from"./index-CIDBdOm7.js";import{P as y}from"./Placeholder-DMQEmhkP.js";import{u as x}from"./Gltf-BXCBC9MC.js";import"./leva.esm-DSVJ0qOL.js";import"./constants-DLw663vx.js";const m=t=>t===Object(t)&&!Array.isArray(t)&&typeof t!="function";function s(t,a){const i=g(o=>o.gl),e=c(u,m(t)?Object.values(t):t);return n.useLayoutEffect(()=>{a?.(e)},[a]),n.useEffect(()=>{if("initTexture"in i){let o=[];Array.isArray(e)?o=e:e instanceof d?o=[e]:m(e)&&(o=Object.values(e)),o.forEach(l=>{l instanceof d&&i.initTexture(l)})}},[i,e]),n.useMemo(()=>{if(m(t)){const o={};let l=0;for(const p in t)o[p]=e[l++];return o}else return e},[t,e])}s.preload=t=>c.preload(u,t);s.clear=t=>c.clear(u,t);function S(t){const a=x("models/LeePerrySmith/LeePerrySmith.glb");console.log("modelo"),console.log(a),a.materials["Material.002"].map=s("models/LeePerrySmith/color.jpg"),a.materials["Material.002"].normal=s("models/LeePerrySmith/normal.jpg"),a.materials["Material.002"].normalMap=s("models/LeePerrySmith/normal.jpg");const i={uTime:{value:0}};return h((e,f)=>{i.uTime.value=e.clock.elapsedTime}),a.materials["Material.002"].onBeforeCompile=e=>{console.log(e.vertexShader),e.uniforms.uTime=i.uTime,e.vertexShader=e.vertexShader.replace("#include <common>",`
            #include <common>
...
//# sourceMappingURL=shader-BIWyqsOg.js.map
